...
import CourseDetailsSix from "../courseSingle/CourseDetailsSix";
import { getExamById } from "@/service/exam";
import ExamListSeven from "../examList/ExamListSeven";
import ExamSix from "../homes/exam/ExamSix";
import ExamSeven from "../homes/exam/ExamSeven";
...
export default function SubjectDetailsSix({ id }) {
            ...
            <div className="col-lg-8">
              <div className="tabs__content js-tabs-content">
                ...
                >
                  ...
                  <ExamListSeven courseList={pageItem?.course}/>
                </div>
